...
ui.add('modal', function (w, d) {
    ...
    return function (_ui$ui) {
        ...
        _createClass(Modal, null, [{
            ...
            get: function get() {
                return {
                    transform: function transform(modal, insert, callback) {
                        return function () {
                            ...
                            modal.transform.css({
                            ...
                            }).appendTo(modal.substrate).one('transitionend', function () {
                                ...
                                } else transformEndCSS.borderRadius = modal.window.css('borderRadius');

                                this.transform.one('transitionend', function () {
                                    modal.window.removeClass('invisible');

                                    setTimeout(function () {
                                        modal.transform.one('transitionend', function (e) {
                                            console.log(e);
                                ...
                                }.bind(modal)).css(transformEndCSS);
                            }.bind(modal));
                    ...
                    class: function _class(modal, insert, callback) {
                        return function (classes) {
                            classes = classes || 'fade';

                            modal.nodes.window.addClass('class-animation').addClass(classes);

                            insert();

                            setTimeout(function () {
                                modal.nodes.window.on('transitionend', function (e) {
                                    modal.nodes.window.removeClass('class-animation');

                                    callback();
                                }.bind(this)).removeClass(classes);
                            }, 0);
                        };
                    }
                };
            ...
            get: function get() {
                return {
                    transform: function transform(modal, callback) {
                        modal.transform = $('<div>').addClass('modal transform transparent');
                        ...
                        setTimeout(function () {
                            modal.transform.one('transitionend', function () {
                                modal.window.addClass('invisible');
                    ...
                    class: function _class(modal, callback) {
                        return function (classes) {
                            classes = classes || 'fade';
                            modal.nodes.window.addClass('class-animation');

                            setTimeout(function () {
                                modal.nodes.window.one('transitionend', function () {
        ...
        function Modal(element, options) {
            ...
            return _possibleConstructorReturn(this, (Modal.__proto__ || Object.getPrototypeOf(Modal)).call(this, 'modal', element, options, function () {}, function () {
                this.permission = true;
                this.nodes.element.click(function (e) {
                    e.preventDefault();
                    if (this.permission) {
                        this.open();
                    }
                ...
                if (is.string(this.options.content)) this.options.content = $(this.options.content);
            }));
        }
        ...
        _createClass(Modal, [{
            ...
            value: function resize() {
                var modalHeight = this.nodes.modal.outerHeight();
            ...
            value: function open() {
                ...
                if (is.string(this.options.content)) this.nodes.window = $(this.options.content);else if (is.$(this.options.content) && this.options.content.length > 1) this.nodes.window = $('<div class="window container">').append(this.options.content);else if (is.$(this.options.content) && this.options.content.length == 1) this.nodes.window = this.options.content;

                if (!this.nodes.window.hasClass('window')) this.nodes.window.addClass('window');

                if (!this.nodes.window.hasClass('container')) this.nodes.window.addClass('container');

                if (this.options.windowClass) this.nodes.window.addClass(this.options.windowClass);

                this.nodes.window.appendTo(this.nodes.modal);

                if (this.options.substrate) {
                    this.nodes.substrate = $('<div class="substrate fade transparent">').on('click', this.close.bind(this)).appendTo(this.nodes.modal);

                    if (this.options.substrateClass) this.nodes.substrate.addClass(this.options.substrateClass);
                }
                ...
                var openEffect = void 0;
                if (is.function(this.options.openEffect)) openEffect = this.options.openEffect;else if (is.string(this.options.openEffect) && is.function(Modal.openEffects[this.options.openEffect])) openEffect = Modal.openEffects[this.options.openEffect];else openEffect = Modal.openEffects['class'];

                if (is.array(this.options.openEffectApply)) openEffect.apply();
                ...
                openEffect = openEffect(this, function () {
                    ...
                    if (this.nodes.substrate) setTimeout(function () {
                        this.nodes.substrate.removeClass('transparent');
                    }.bind(this), 0);
                }.bind(this), function () {
                ...
                if (is.array(this.options.openEffectApply)) openEffect.apply(null, this.options.openEffectApply);else openEffect(this.options.openEffectApply);
            ...
            value: function close() {
                ...
                var closeEffect = void 0;
                if (is.function(this.options.closeEffect)) closeEffect = this.options.closeEffect;else if (is.string(this.options.closeEffect) && is.function(Modal.closeEffects[this.options.closeEffect])) closeEffect = Modal.closeEffects[this.options.closeEffect];else closeEffect = Modal.closeEffects['class'];
                ...
                } else closeEffect = closeEffect(this, afterClose);

                if (is.array(this.options.closeEffectApply)) closeEffect.apply(null, this.options.closeEffectApply);else closeEffect(this.options.closeEffectApply);

                if (this.nodes.substrate) this.nodes.substrate.addClass('transparent');
