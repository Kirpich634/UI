...
(function ($) {
	var tpl = '<div class="container">' + '<div class="select-color"><div><div></div></div></div>' + '<div class="hue"></div>' + '<div class="preview">' + '<div class="new"></div>' + '<div class="current"></div>' + '</div>' + '<div class="field rgb r "><input type="text" maxlength="3" size="3"></div>' + '<div class="field hsb h"><input type="text" maxlength="3" size="3"></div>' + '<div class="field rgb g"><input type="text" maxlength="3" size="3"></div>' + '<div class="field hsb s"><input type="text" maxlength="3" size="3"></div>' + '<div class="field rgb b"><input type="text" maxlength="3" size="3"></div>' + '<div class="field hsb b"><input type="text" maxlength="3" size="3"></div>' + '<div class="opacity"><div></div></div>' + '<div class="field hex"><input type="text" maxlength="6"></div>' + '<div class="submit"><i class="material-icons md-18">invert_colors</i></div>' + '</div>',
	...
	var init = function init(parent, options) {
		...
		}.bind(this)).on('colorchangestart', function () {
	...
	init.prototype = {
		...
		setPreviewCurrent: function setPreviewCurrent() {
		...
		getColor: function getColor(hsb, opacity) {
	...
	$.fn.uicolorpicker = function () {
		...
		if (this.data('colorpicker')) {
			...
			switch (arguments[0]) {
				case 'openEffect':
					if ($.isFunction(arguments[1])) colorpicker.dropdown.effects.open = arguments[1];else console.error('Effect must be function');

					break;
				case 'closeEffect':
					if ($.isFunction(arguments[1])) colorpicker.dropdown.effects.close = arguments[1];else console.error('Effect must be function');
				...
				case 'color':
					...
					} else return colorpicker.getColor(colorpicker.hsb.new, colorpicker.opacity.new);
