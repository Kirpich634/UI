...
(function ($) {
    ...
    init.prototype = {
        open: function () {
            ...
            _this.blackout = create.blackout()
                .appendTo('body')
                .fadeIn()
                .click(function(){
                    _this.close()
            ...
            _this.container = create.container(_this.target[0])
                ...
                .fadeIn(100, function () {
                    ...
                    for (var kay in _this.css) if ( kay != "width" || kay != "height" || kay != "top" || kay != "left") styleList[kay] = _this.css[kay];
        ...
        close: function () {
            ...
            if ( _this.css.backgroundColor && _this.target.css('backgroundColor') != "rgba(0, 0, 0, 0)" )
                styleList.backgroundColor = _this.target.css('backgroundColor');
